...
PS1='\[\033[0;32m\]\[\033[0m\033[0;32m\]\u\[\033[0;35m\] @ \w\[\033[0;36m\]$(if git rev-parse --git-dir > /dev/null 2>&1; then echo " - ["; fi)$(git branch 2>/dev/null | grep "^*" | colrm 1 2)\[\033[0;32m\]$(if git rev-parse --git-dir > /dev/null 2>&1; then echo "]"; fi)\[\033[0m\033[0;32m\] \$\[\033[0m\033[0;32m\]\[\033[0m\] '
...
export PATH=/opt/infer/infer/bin:$PATH
export SVN_EDITOR=vim
# Install Ruby Gems to ~/gems
export GEM_HOME="$HOME/gems"
export PATH="$HOME/gems/bin:$PATH"
export PATH="$HOME/bin:$PATH"
export PATH="/opt/clingo-5.3.0-linux-x86_64:$PATH"
